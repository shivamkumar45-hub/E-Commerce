...
const UpdateOrder = () => {
  ...
  const handleStatusUpdate=()=>{
   ...
   dispatch(updateOrderStatus({orderId,status}))
      ...
      useEffect(()=>{
        ...
        if(success){
          toast.success("Order Status Updated Successully",{position:'top-center',autoClose:2000})
 ...
 {loading?(<Loader/>):<div className="order-container">
  ...
  <div className="order-details">
    ...
    <p><strong>Shipping Address: </strong>{`${shippingInfo.address}, ${shippingInfo.city}, ${shippingInfo.state}, ${shippingInfo.pinCode}, ${shippingInfo.country}`}</p>
  ...
  <div className="order-items">
    ...
    <table className="order-table">
      ...
      <tbody>
       { orderItems.map((item)=>(<tr key={item._id}>
          <td>
